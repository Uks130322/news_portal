"""
This script sends weekly emails in case of adding new post in subscribed category.
It's commented because here we used apscheduler, but now we do it with celery
"""
#
# import datetime
# import logging
